...
def process_rows(rows):
    ...
    for row_idx in range(num_rows):
        ...
        for cell_idx in range(num_cells):
            if rows[row_idx][cell_idx] == CELL_ROLL:
                adjacent_rolls = 0
                ...
                if cell_idx > 0:
                    ...
                    if row_idx > 0:
                        ...
                        adjacent_rolls += (1 if rows[row_idx - 1][cell_idx - 1] != CELL_EMPTY else 0)
                    if row_idx < num_rows - 1:
                        # Bottom row has no bottom-left neighbour
                        adjacent_rolls += (1 if rows[row_idx + 1][cell_idx - 1] != CELL_EMPTY else 0)

                    adjacent_rolls += (1 if rows[row_idx][cell_idx - 1] != CELL_EMPTY else 0)
                ...
                if row_idx > 0:
                    ...
                    adjacent_rolls += (1 if rows[row_idx - 1][cell_idx] != CELL_EMPTY else 0)
